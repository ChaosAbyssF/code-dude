...
For bug fixes, Codex should first consider a minimal reproduction surface before changing implementation code. If a focused failing test or reproduction command already exists, use it. If not, add a narrow regression test, fixture, or smoke script in the repository's normal test structure when practical.
...
- a minimal reproduction command for the reported bug
